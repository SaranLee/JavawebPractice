...
jQuery.extend( {
	...
	ajax: function( url, options ) {
		...
		// A cross-demo.domain request is in order when the origin doesn't match the current origin.
...
jQuery.ajaxTransport( "script", function( s ) {
	...
	// This transport only deals with cross demo.domain or forced-by-attrs requests
