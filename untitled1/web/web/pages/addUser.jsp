                    ...
                    <div class="col-lg-3">
                        <div class="card card-primary">
                            ...
                            <form role="form">
                                ...
                                <div style="text-align: center; padding-left: 20px; padding-right: 20px; padding-bottom: 20px">
                                    <button class="btn btn-primary container-fluid" id="btn_addUser">添加</button>
                                </div>
                                <div>
                                    <a href="${pageContext.request.contextPath}/download">下载头像</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script>
    ...
    $("#btn_addUser").click(function () {
        ...
        //ajax请求是否已经存在该用户名
        $.post("user?method=exist", {username:username}, function (respText) {
            if(respText === "true"){
                $("input[name='username']").addClass("is-invalid");
                layer.tips('该用户名已存在', '#username', {time: 2000, tips:[2, "#ca3546"], anim:6});
            }else{
                //ajax请求添加用户
    ...
    $("#username").blur(function () {
        ...
        $.post("user?method=exist", {username:username}, function (respText) {
            if(respText === "true"){
                $("input[name='username']").addClass("is-invalid");
                layer.tips('该用户名已存在', '#username', {time: 2000, tips:[2, "#ca3546"]});
            }else{
    ...
    //点击用户头像，打开layer修改用户头像
    $("#login_user_avatar").click(function () {
        layer.open({
            type: 2,
            title: false,
            shadeClose: true,
            ...
            offset: "100px",
            closeBtn: 0,
            content: 'pages/modifyAvatar.jsp' //iframe的url
        });
    })
</script>
